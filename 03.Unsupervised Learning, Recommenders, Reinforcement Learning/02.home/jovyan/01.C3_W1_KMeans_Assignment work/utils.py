...
def plot_progress_kMeans(X, centroids, previous_centroids, idx, K, i, finale = False):
    # Plot the examples
    ...
    if (finale == False) : 
        ...
        # Plot the centroids as black 'x's
        plt.scatter(centroids[:, 0], centroids[:, 1], marker='x', c='g', linewidths=3)
...
def plot_kMeans_RGB(X, centroids, idx, K):
    ...
    # For matplotlib API Changes for 3.8.0 Axes3D
